...
range_expr                  :   IDENT COLON DIGITS NUMRANGE simple_expr {
                                                                          ...
                                                                          symbol_table.symbols = (symbol_t **)realloc(symbol_table.symbols, sizeof(symbol_t *) * (symbol_table.count+1));
                                                                          symbol_table.symbols[symbol_table.count] = (symbol_t *)malloc(sizeof(symbol_t));
                                                                          symbol_table.symbols[symbol_table.count]->name = strdup($1);
                                                                          symbol_table.symbols[symbol_table.count]->expr = st_expr_copy($$);
                                                                          symbol_table.count++;
